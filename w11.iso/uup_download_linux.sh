...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=5aa4a1a2-8bd2-4b8b-b463-523d7c944ca3&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then

@echo off
:: Generated on 2026-06-02 12:32:13 GMT
...
:START_PROCESS
title 19044.1806_amd64_zh-cn_professional_abb3603c download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=abb3603c-defd-4385-ac3e-a7fb0ef589e4&pack=zh-cn&edition=professional&aria2=2"

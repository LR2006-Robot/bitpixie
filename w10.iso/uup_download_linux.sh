...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=abb3603c-defd-4385-ac3e-a7fb0ef589e4&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
